...
//router.get('/by-event/:event', isAuthenticated, validate.validateEventParam(), validate.checkPhotoValidation, photosController.getPhotosByEvent);

router.get('/by-date/:date', validate.validateDateParam(), validate.checkPhotoValidation, photosController.getPhotosByDate);
//router.get('/by-date/:date', isAuthenticated, validate.validateDateParam(), validate.checkPhotoValidation, photosController.getPhotosByDate);

// ID route
router.get('/:id', photosController.getPhotoById);
//router.get('/:id', isAuthenticated, photosController.getPhotoById);

// Get all
router.get('/', photosController.getAllPhotos);
//router.get('/', isAuthenticated, photosController.getAllPhotos);

// POST route
router.post('/', validate.validatePhoto(), validate.checkPhotoValidation, photosController.createPhoto);
//router.post('/', isAuthenticated, validate.validatePhoto(), validate.checkPhotoValidation, photosController.createPhoto);

// PUT route
router.put('/:id', validate.validatePhoto(), validate.checkPhotoValidation, photosController.updatePhoto);
